...
# TABS
# ============================================
tab1, tab2, tab3, tab4, tab5 = st.tabs(["📈 Price Chart", "🥧 Market Cap", "📋 Data", "⚡ Compare", "📘 Financial Literacy"])
...
with tab5:
    st.title("📘 Financial Literacy")

    st.caption("This section helps users understand basic financial concepts.")

    st.write("Learn basic stock market concepts:")

    terms = {
        "📊 Stock": "A stock represents ownership in a company.",
        "💰 Investment": "Putting money into something to earn profit.",
        "📈 Profit": "The money you gain from an investment.",
        "⚠️ Risk": "The chance of losing money.",
        "💸 Dividend": "A part of company profit paid to shareholders.",
        "🏦 Market": "A place where stocks are bought and sold."
    }
